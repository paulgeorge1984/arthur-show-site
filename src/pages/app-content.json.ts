...
const scheduleEvents = [
	...
	{
		id: 'blessing-night-kagurazaka-2026-07-17',
		title: 'BLESSING NIGHT 神楽坂',
		label: 'NEXT BLESSING NIGHT',
		startsAt: '2026-07-17T19:00:00+09:00',
		timeLabel: '2026.7.17 FRI / OPEN 18:30 / START 19:00',
		location: 'u-ma kagurazaka',
		address: '東京都新宿区矢来町132-5',
		description: '不良牧師が語る聖なる夜のトークライブ。Music Guest は Migiwa。',
		image: 'https://arthur-show.com/assets/generated/blessing-night-kagurazaka-20260717-banner.webp',
		url: 'https://www.blessingnight.jp/schedule/schedule366',
		mapUrl: 'https://maps.google.com/?q=u-ma%20kagurazaka',
	},
	{
